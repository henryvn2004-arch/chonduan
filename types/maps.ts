...
export interface FilterState {
  ...
  province?: string
  district?: string
  status?: string                // single-select (SearchClient)
  bedrooms?: string              // '1'|'2'|'3'|'4+' (SearchClient rent mode)
  tiers?: string[]               // multi-select (FilterSidebar)
  statuses?: string[]            // multi-select (FilterSidebar)
