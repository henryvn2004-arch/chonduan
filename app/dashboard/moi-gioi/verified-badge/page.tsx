  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA]">
      ...
      <main className="max-w-lg mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className={`w-12 h-12 rounded-full flex items-center justify-center text-2xl ${isActive ? 'bg-blue-50' : 'bg-gray-100'}`}>
                {isActive ? '✅' : '🔘'}
              </div>
              <div>
        ...
        {/* Benefits */}
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6">
          <h2 className="font-semibold text-[#0D1B3D] mb-4">Lợi ích Verified Badge ✅</h2>
          <ul className="space-y-3 text-sm text-[#374151]">
            {[
              ...
              <li key={i} className="flex items-start gap-2.5">
                <span className="text-[#1565FF] mt-0.5 shrink-0">•</span>
                <span>{benefit}</span>
              </li>
            ))}
          </ul>
